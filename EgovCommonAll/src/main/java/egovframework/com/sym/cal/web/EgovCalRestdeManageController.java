...
public class EgovCalRestdeManageController {
	...
	@RequestMapping(value="/sym/cal/EgovselectAdministCalendar.do")
 	public String selectAdministRestdePopup (Restde restde, BindingResult bindingResult
        ...
        List<EgovMap> CalInfoList = restdeManageService.selectAdministRestdePopup(restde);
	...
	@RequestMapping(value="/sym/cal/EgovNormalDayCalendar.do")
 	public String selectNormalDayCalendar (Restde restde, BindingResult bindingResult
		...
		List<EgovMap> CalInfoList          = restdeManageService.selectNormalDayCal(restde);
        List<EgovMap> NormalWeekRestdeList = restdeManageService.selectNormalDayRestde(restde);
	...
	@RequestMapping(value="/sym/cal/EgovNormalMonthCalendar.do")
 	public String selectNormalMonthCalendar (Restde restde, BindingResult bindingResult
        ...
        List<EgovMap> NormalMonthRestdeList = restdeManageService.selectNormalMonthRestde(restde);
	...
	@RequestMapping(value="/sym/cal/EgovNormalYearCalendar.do")
 	public String selectNormalYearCalendar (Restde restde, BindingResult bindingResult
        ...
        List<EgovMap> NormalMonthRestdeList_1 = restdeManageService.selectNormalMonthRestde(restde);
        ...
        List<EgovMap> NormalMonthRestdeList_2 = restdeManageService.selectNormalMonthRestde(restde);
        ...
        List<EgovMap> NormalMonthRestdeList_3 = restdeManageService.selectNormalMonthRestde(restde);
        ...
        List<EgovMap> NormalMonthRestdeList_4 = restdeManageService.selectNormalMonthRestde(restde);
        ...
        List<EgovMap> NormalMonthRestdeList_5 = restdeManageService.selectNormalMonthRestde(restde);
        ...
        List<EgovMap> NormalMonthRestdeList_6 = restdeManageService.selectNormalMonthRestde(restde);
        ...
        List<EgovMap> NormalMonthRestdeList_7 = restdeManageService.selectNormalMonthRestde(restde);
        ...
        List<EgovMap> NormalMonthRestdeList_8 = restdeManageService.selectNormalMonthRestde(restde);
        ...
        List<EgovMap> NormalMonthRestdeList_9 = restdeManageService.selectNormalMonthRestde(restde);
        ...
        List<EgovMap> NormalMonthRestdeList_10 = restdeManageService.selectNormalMonthRestde(restde);
        ...
        List<EgovMap> NormalMonthRestdeList_11 = restdeManageService.selectNormalMonthRestde(restde);
        ...
        List<EgovMap> NormalMonthRestdeList_12 = restdeManageService.selectNormalMonthRestde(restde);
	...
	@RequestMapping(value="/sym/cal/EgovAdministDayCalendar.do")
 	public String selectAdministDayCalendar (Restde restde, BindingResult bindingResult
		...
		List<EgovMap> CalInfoList          = restdeManageService.selectAdministDayCal(restde);
        List<EgovMap> AdministWeekRestdeList = restdeManageService.selectAdministDayRestde(restde);
	...
	@RequestMapping(value="/sym/cal/EgovAdministYearCalendar.do")
 	public String selectAdministYearCalendar (Restde restde, BindingResult bindingResult
		...
		restde.setStartWeekMonth(cal.get(Calendar.DAY_OF_WEEK));
		restde.setLastDayMonth(cal.getActualMaximum(Calendar.DATE));
        List<EgovMap> CalInfoList_1 = restdeManageService.selectAdministRestdePopup(restde);
		...
		restde.setStartWeekMonth(cal.get(Calendar.DAY_OF_WEEK));
		restde.setLastDayMonth(cal.getActualMaximum(Calendar.DATE));
        List<EgovMap> CalInfoList_2 = restdeManageService.selectAdministRestdePopup(restde);
		...
		restde.setStartWeekMonth(cal.get(Calendar.DAY_OF_WEEK));
		restde.setLastDayMonth(cal.getActualMaximum(Calendar.DATE));
        List<EgovMap> CalInfoList_3 = restdeManageService.selectAdministRestdePopup(restde);
		...
		restde.setStartWeekMonth(cal.get(Calendar.DAY_OF_WEEK));
		restde.setLastDayMonth(cal.getActualMaximum(Calendar.DATE));
        List<EgovMap> CalInfoList_4 = restdeManageService.selectAdministRestdePopup(restde);
		...
		restde.setStartWeekMonth(cal.get(Calendar.DAY_OF_WEEK));
		restde.setLastDayMonth(cal.getActualMaximum(Calendar.DATE));
        List<EgovMap> CalInfoList_5 = restdeManageService.selectAdministRestdePopup(restde);
		...
		restde.setStartWeekMonth(cal.get(Calendar.DAY_OF_WEEK));
		restde.setLastDayMonth(cal.getActualMaximum(Calendar.DATE));
        List<EgovMap> CalInfoList_6 = restdeManageService.selectAdministRestdePopup(restde);
		...
		restde.setStartWeekMonth(cal.get(Calendar.DAY_OF_WEEK));
		restde.setLastDayMonth(cal.getActualMaximum(Calendar.DATE));
        List<EgovMap> CalInfoList_7 = restdeManageService.selectAdministRestdePopup(restde);
		...
		restde.setStartWeekMonth(cal.get(Calendar.DAY_OF_WEEK));
		restde.setLastDayMonth(cal.getActualMaximum(Calendar.DATE));
        List<EgovMap> CalInfoList_8 = restdeManageService.selectAdministRestdePopup(restde);
		...
		restde.setStartWeekMonth(cal.get(Calendar.DAY_OF_WEEK));
		restde.setLastDayMonth(cal.getActualMaximum(Calendar.DATE));
        List<EgovMap> CalInfoList_9 = restdeManageService.selectAdministRestdePopup(restde);
		...
		restde.setStartWeekMonth(cal.get(Calendar.DAY_OF_WEEK));
		restde.setLastDayMonth(cal.getActualMaximum(Calendar.DATE));
        List<EgovMap> CalInfoList_10 = restdeManageService.selectAdministRestdePopup(restde);
		...
		restde.setStartWeekMonth(cal.get(Calendar.DAY_OF_WEEK));
		restde.setLastDayMonth(cal.getActualMaximum(Calendar.DATE));
        List<EgovMap> CalInfoList_11 = restdeManageService.selectAdministRestdePopup(restde);
		...
		restde.setStartWeekMonth(cal.get(Calendar.DAY_OF_WEEK));
		restde.setLastDayMonth(cal.getActualMaximum(Calendar.DATE));
        List<EgovMap> CalInfoList_12 = restdeManageService.selectAdministRestdePopup(restde);
